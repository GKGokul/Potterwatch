...
public class QuestionPVP extends AppCompatActivity {

    private QuestionPVP.CountDown count;
    private int QuestionCounter = 0;
    private int score = 0;
    private int compScore = 0;
    private String AnswerKey;
    private int buttonColor,scoreColor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (QuestionCounter == 0) {
            new QuestionPVP.getQuestions(QuestionPVP.this).execute();
        }
    ...
    private class getQuestions extends AsyncTask<String, String, String> {
        ...
        public getQuestions(android.app.Activity Activity) {
    ...
    private void updateUI() throws JSONException {
        ...
        h.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                count = new QuestionPVP.CountDown(11000,100);
                count.start();
            }
        },1500);
    }
            ...
            public void run() {
                try {
                    ...
                    if (QuestionCounter < 10) {
                        ...
                        Intent intent = new Intent(QuestionPVP.this,ResultPage.class);
